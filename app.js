...
// Ingredients: // array as list
    ...
    //is cold 
    let isCold = document.createElement('p');
        isCold.textContent= `cold : ${this.isCold}`
        sectionEl.appendChild(isCold);

    //is hot        
    let isHot= document.createElement('p');
        isHot.textContent= `HOt : ${this.isHot}`
        sectionEl.appendChild(isHot);
